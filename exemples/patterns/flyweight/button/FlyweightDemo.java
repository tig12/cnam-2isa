/** 
    Source : https://sourcemaking.com/design_patterns/flyweight/java/2
    Code complété pour compiler sans warning + quelques nettoyages.
**/
...
class FlyweightFactory {
    ...
    private static Map<String, Button> treeMap = new TreeMap<>();
    ...
    public static Button makeButton(String num) {
        ...
        if (treeMap.containsKey(num)) {
            ...
            //    pattern provides.]
            button = new Button((treeMap.get(num)).getLabel());
            sharedButtons++;
        } else {
